...
import com.sukabumikota.sipajar.lappajak.DenganDetail;
import com.sukabumikota.sipajar.lappajak.HanyaFoto;
import com.sukabumikota.sipajar.model.SemuaObjekPajakItem;

import java.util.List;

public class Op2Adapter extends RecyclerView.Adapter<Op2Adapter.ObjekPajakHolder>{
    List<SemuaObjekPajakItem> semuaobjekpajakItemList;
    Context mContext;

    public Op2Adapter(Context context, List<SemuaObjekPajakItem> objekpajaklist){
        this.mContext = context;
        semuaobjekpajakItemList = objekpajaklist;
    }
    @NonNull
    @Override
    public Op2Adapter.ObjekPajakHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_rvobjekpajak, parent, false);
        return new Op2Adapter.ObjekPajakHolder(itemView);
    }
    @Override
    public void onBindViewHolder(@NonNull Op2Adapter.ObjekPajakHolder holder, int position){
        ...
        holder.cvop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent moveToDetail = new Intent(mContext, DenganDetail.class);
